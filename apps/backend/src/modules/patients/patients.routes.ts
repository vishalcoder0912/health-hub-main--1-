...
patientsRouter.put("/:id", validate({ params: patientIdParamSchema, body: updatePatientSchema }), requireRoles([UserRole.admin, UserRole.receptionist]), controller.updatePatient);
