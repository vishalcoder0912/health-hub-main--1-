...
import { PatientRecordsSupabase } from './PatientRecordsSupabase';
...
const navItems = [
  ...
  { title: 'Patient Records (DB)', href: '/admin/patient-records', icon: Users },
  ...
  return (
    <DashboardLayout navItems={navItems} title="Admin Dashboard">
      <Routes>
        ...
        <Route path="patient-records" element={<PatientRecordsSupabase />} />
